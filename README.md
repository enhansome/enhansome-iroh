...
* [p2pmux](https://github.com/pelazas/p2pmux) ⭐ 69 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - Terminal multiplexer where every pane is a PTY on its owner's own machine.
* [linXiv](https://github.com/linxiv-dev/linXiv) ⭐ 48 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - Local-first academic paper manager with p2p sharing enabled using iroh.
...
* [Rayfish](https://github.com/rayfish/rayfish) ⭐ 686 | 🐛 71 | 🌐 Rust | 📅 2026-09-15 - A P2P mesh VPN that connects peers by cryptographic identity instead of IP address.
* [Codux](https://github.com/duxweb/codux) ⭐ 448 | 🐛 48 | 🌐 Rust | 📅 2026-07-21 - A native connected terminal for AI coding agents, using iroh for encrypted peer-to-peer control across desktop, mobile, and headless hosts.
...
* [Tunnet](https://github.com/tunnetio/Tunnet) ⭐ 109 | 🐛 5 | 🌐 Rust | 📅 2026-09-15 - Open-source mesh networking platform that scales from direct p2p connections for individuals to fully managed deployments for large organizations.
...
* [locho](https://github.com/trchopan/locho) ⭐ 6 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Local + echo = locho: Access a private service on another machine as if it were local.
* [Resilum Core](https://github.com/Resilum/resilum-core) ⭐ 3 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - Multi-transport Reticulum node: one peer identity across Tor, I2P, Yggdrasil, BLE and iroh/QUIC, with LXMF messaging and SOCKS5 egress.

## File Sharing

* [Alt-sendme](https://github.com/tonyantony300/alt-sendme) ⭐ 9,481 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-01 - A cross-platform desktop application for file sharing, built with Tauri.
...
* [DataBeam](https://github.com/vinay-winai/DataBeam) ⭐ 14 | 🐛 4 | 🌐 Rust | 📅 2026-09-09 - File sharing desktop app with features like: share via short custom code or QR code, share text, auto-retry on failure, and automatic overwrite conflict resolution.
...
* [p2panda](https://github.com/p2panda/p2panda) ⭐ 563 | 🐛 165 | 🌐 Rust | 📅 2026-09-15 - Building blocks for peer-to-peer applications.
...
* [Fedimint](https://github.com/fedimint/fedimint) ⭐ 696 | 🐛 385 | 🌐 Rust | 📅 2026-09-15 - Federated E-Cash Mint.
...
[Thanks goes to these contributors](https://github.com/n0-computer/awesome-iroh/graphs/contributors) ⭐ 547 | 🐛 3 | 📅 2026-09-13!
