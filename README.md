...
* [Teamtype](https://github.com/teamtype/teamtype) ⭐ 1,928 | 🐛 111 | 🌐 Rust | 📅 2026-09-25 - Editor-agnostic, real-time collaborative editing of local text files.
...
* [linXiv](https://github.com/linxiv-dev/linXiv) ⭐ 53 | 🐛 24 | 🌐 Rust | 📅 2026-09-25 - Local-first academic paper manager with p2p sharing enabled using iroh.
...
* [Rayfish](https://github.com/rayfish/rayfish) ⭐ 704 | 🐛 78 | 🌐 Rust | 📅 2026-09-25 - A P2P mesh VPN that connects peers by cryptographic identity instead of IP address.
* [Codux](https://github.com/duxweb/codux) ⭐ 460 | 🐛 49 | 🌐 Rust | 📅 2026-07-21 - A native connected terminal for AI coding agents, using iroh for encrypted peer-to-peer control across desktop, mobile, and headless hosts.
...
* [Tunnet](https://github.com/tunnetio/Tunnet) ⭐ 175 | 🐛 5 | 🌐 Rust | 📅 2026-09-25 - Open-source mesh networking platform that scales from direct p2p connections for individuals to fully managed deployments for large organizations.
...
* [koh](https://github.com/gold-silver-copper/koh) ⭐ 34 | 🐛 0 | 🌐 HTML | 📅 2026-09-25 - A remote shell inspired by mosh. Serve and connect from anywhere, survive network changes, no port forwarding required.
...
* [locho](https://github.com/trchopan/locho) ⭐ 6 | 🐛 3 | 🌐 Rust | 📅 2026-09-23 - Local + echo = locho: Access a private service on another machine as if it were local.
...
* [Alt-sendme](https://github.com/tonyantony300/alt-sendme) ⭐ 9,746 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-01 - A cross-platform desktop application for file sharing, built with Tauri.
...
* [p2panda](https://github.com/p2panda/p2panda) ⭐ 570 | 🐛 182 | 🌐 Rust | 📅 2026-09-24 - Building blocks for peer-to-peer applications.
...
* [Fedimint](https://github.com/fedimint/fedimint) ⭐ 699 | 🐛 401 | 🌐 Rust | 📅 2026-09-25 - Federated E-Cash Mint.
