...
* [linXiv](https://github.com/linxiv-dev/linXiv) ⭐ 52 | 🐛 7 | 🌐 Rust | 📅 2026-09-20 - Local-first academic paper manager with p2p sharing enabled using iroh.
...
* [Rayfish](https://github.com/rayfish/rayfish) ⭐ 696 | 🐛 78 | 🌐 Rust | 📅 2026-09-21 - A P2P mesh VPN that connects peers by cryptographic identity instead of IP address.
* [Codux](https://github.com/duxweb/codux) ⭐ 453 | 🐛 49 | 🌐 Rust | 📅 2026-07-21 - A native connected terminal for AI coding agents, using iroh for encrypted peer-to-peer control across desktop, mobile, and headless hosts.
...
* [Tunnet](https://github.com/tunnetio/Tunnet) ⭐ 112 | 🐛 6 | 🌐 Rust | 📅 2026-09-21 - Open-source mesh networking platform that scales from direct p2p connections for individuals to fully managed deployments for large organizations.
...
* [Edky](https://github.com/artob/edky) ⭐ 15 | 🐛 7 | 🌐 Rust | 📅 2026-09-21 - Convert Ed25519 public keys between various encoding formats (iroh, libp2p, IPFS, OpenSSH, etc).
...
* [Resilum Core](https://github.com/Resilum/resilum-core) ⭐ 4 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - Multi-transport Reticulum node: one peer identity across Tor, I2P, Yggdrasil, BLE and iroh/QUIC, with LXMF messaging and SOCKS5 egress.

## File Sharing

* [Alt-sendme](https://github.com/tonyantony300/alt-sendme) ⭐ 9,697 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-01 - A cross-platform desktop application for file sharing, built with Tauri.
* [Sendme](https://github.com/n0-computer/sendme) ⭐ 1,193 | 🐛 38 | 🌐 Rust | 📅 2026-07-25 - A tool to send files and directories, based on iroh.
...
* [ringdrop](https://github.com/rikettsie/ringdrop) ⭐ 25 | 🐛 5 | 🌐 Rust | 📅 2026-09-19 - Frugal, daemonized P2P file transfer with ring-based access control, built on iroh and bao protocols.
...
* [p2panda](https://github.com/p2panda/p2panda) ⭐ 568 | 🐛 167 | 🌐 Rust | 📅 2026-09-21 - Building blocks for peer-to-peer applications.
...
* [Fedimint](https://github.com/fedimint/fedimint) ⭐ 699 | 🐛 395 | 🌐 Rust | 📅 2026-09-21 - Federated E-Cash Mint.
...
[Thanks goes to these contributors](https://github.com/n0-computer/awesome-iroh/graphs/contributors) ⭐ 552 | 🐛 4 | 📅 2026-09-13!
