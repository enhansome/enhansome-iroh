...
* [linXiv](https://github.com/linxiv-dev/linXiv) ⭐ 51 | 🐛 7 | 🌐 Rust | 📅 2026-09-20 - Local-first academic paper manager with p2p sharing enabled using iroh.
* [biter](https://github.com/LukeDSchenk/biter) ⭐ 11 | 🐛 7 | 🌐 Rust | 📅 2026-02-05 - Synchronize device clipboards via iroh.

## DevTools

* [Dumbpipe](https://github.com/n0-computer/dumbpipe) ⭐ 782 | 🐛 30 | 🌐 Rust | 📅 2026-07-20 - Cross-device unix pipe.
* [Rayfish](https://github.com/rayfish/rayfish) ⭐ 695 | 🐛 72 | 🌐 Rust | 📅 2026-09-20 - A P2P mesh VPN that connects peers by cryptographic identity instead of IP address.
...
* [cross.stream](https://github.com/cablehead/xs) ⭐ 225 | 🐛 12 | 🌐 Rust | 📅 2026-09-20 - Local-first event streaming for reactive workflows, with P2P sharing via Iroh.
* [Tunnet](https://github.com/tunnetio/Tunnet) ⭐ 112 | 🐛 6 | 🌐 Rust | 📅 2026-09-20 - Open-source mesh networking platform that scales from direct p2p connections for individuals to fully managed deployments for large organizations.
...
* [Edky](https://github.com/artob/edky) ⭐ 15 | 🐛 7 | 🌐 Rust | 📅 2026-09-20 - Convert Ed25519 public keys between various encoding formats (iroh, libp2p, IPFS, OpenSSH, etc).
...
* [Alt-sendme](https://github.com/tonyantony300/alt-sendme) ⭐ 9,682 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-01 - A cross-platform desktop application for file sharing, built with Tauri.
...
* [Dropwire](https://github.com/muhamadjawdatsalemalakoum/dropwire) ⭐ 29 | 🐛 11 | 🌐 Rust | 📅 2026-09-04 - Send any file directly between devices, end-to-end encrypted and resumable, with no account and no server.
...
* [p2panda](https://github.com/p2panda/p2panda) ⭐ 568 | 🐛 166 | 🌐 Rust | 📅 2026-09-16 - Building blocks for peer-to-peer applications.
...
* [Fedimint](https://github.com/fedimint/fedimint) ⭐ 698 | 🐛 399 | 🌐 Rust | 📅 2026-09-19 - Federated E-Cash Mint.
