...
* [Teamtype](https://github.com/teamtype/teamtype) ⭐ 1,926 | 🐛 114 | 🌐 Rust | 📅 2026-09-19 - Editor-agnostic, real-time collaborative editing of local text files.
...
* [linXiv](https://github.com/linxiv-dev/linXiv) ⭐ 52 | 🐛 7 | 🌐 Rust | 📅 2026-09-22 - Local-first academic paper manager with p2p sharing enabled using iroh.
...
* [Rayfish](https://github.com/rayfish/rayfish) ⭐ 698 | 🐛 82 | 🌐 Rust | 📅 2026-09-22 - A P2P mesh VPN that connects peers by cryptographic identity instead of IP address.
* [Codux](https://github.com/duxweb/codux) ⭐ 454 | 🐛 49 | 🌐 Rust | 📅 2026-07-21 - A native connected terminal for AI coding agents, using iroh for encrypted peer-to-peer control across desktop, mobile, and headless hosts.
* [iroh-ssh](https://github.com/rustonbsd/iroh-ssh) ⭐ 291 | 🐛 11 | 🌐 Rust | 📅 2026-06-24 - SSH to any machine without ip.
* [cross.stream](https://github.com/cablehead/xs) ⭐ 226 | 🐛 12 | 🌐 Rust | 📅 2026-09-20 - Local-first event streaming for reactive workflows, with P2P sharing via Iroh.
* [Tunnet](https://github.com/tunnetio/Tunnet) ⭐ 112 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - Open-source mesh networking platform that scales from direct p2p connections for individuals to fully managed deployments for large organizations.
...
* [Alt-sendme](https://github.com/tonyantony300/alt-sendme) ⭐ 9,714 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-01 - A cross-platform desktop application for file sharing, built with Tauri.
* [Sendme](https://github.com/n0-computer/sendme) ⭐ 1,196 | 🐛 38 | 🌐 Rust | 📅 2026-07-25 - A tool to send files and directories, based on iroh.
...
* [p2panda](https://github.com/p2panda/p2panda) ⭐ 568 | 🐛 173 | 🌐 Rust | 📅 2026-09-22 - Building blocks for peer-to-peer applications.
...
* [iroh-rings](https://github.com/rikettsie/iroh-rings) ⭐ 19 | 🐛 1 | 🌐 Rust | 📅 2026-09-22 - A relationship-based access control protocol for resources over iroh.
...
* [Fish Folk: Jumpy](https://github.com/fishfolk/jumpy) ⭐ 1,880 | 🐛 80 | 🌐 Rust | 📅 2026-01-30 - Tactical 2D shooter in fishy pixels style. Made with Rust-lang 🦀, built on Bones.
...
* [Fedimint](https://github.com/fedimint/fedimint) ⭐ 699 | 🐛 396 | 🌐 Rust | 📅 2026-09-22 - Federated E-Cash Mint.
...
[Thanks goes to these contributors](https://github.com/n0-computer/awesome-iroh/graphs/contributors) ⭐ 553 | 🐛 4 | 📅 2026-09-13!
